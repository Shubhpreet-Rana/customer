...
class _ViewCarsState extends State<ViewCars> {
        ...
        child: Column(
          ...
          children: [
            ...
            selectedTab == 1
              ...
              child: BlocBuilder<ViewCarBloc, ViewCarState>(
                  builder: (context, viewCarState) {
                            ...
                            onNotification: (ScrollNotification scrollInfo) {
                              if (scrollInfo.metrics.pixels ==
                                ...
                                if (!viewCarState.isFetchingMore! &&
                                    viewCarState.hasMoreData! &&
                                    !viewCarState.isLoading!) {
                                  BlocProvider.of<ViewCarBloc>(context).add(
                                      FetchAllVehicle(fetchingMore: true));
                                  BlocProvider.of<ViewCarBloc>(context).add(
                                      GetAllVehicle(
                                          page: viewCarState.currentPage!
                                              .toString()));
                                }
                              }
                              return false;
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      children: [
                        ...
                        Text(
                          "Posted on " +
                             "  ${DateFormat('yyyy-MM-dd ').format(car.createdAt!)}",
                          maxLines: 2,
                          textAlign: TextAlign.center,
  ...
  MyListedCarView() {
    return BlocBuilder<ViewCarBloc, ViewCarState>(
        builder: (context, myCarState) {
      if (myCarState is GetMyMarketLoading) {
        return const Center(child: CircularProgressIndicator());
      }
      if (myCarState is NoMyMarketVehicleFound &&
          myCarState.currentPageMyMarket == null) {
        return Expanded(
          child: Container(
            width: CommonMethods.deviceWidth(),
            height: CommonMethods.deviceHeight(),
                  ...
                  onNotification: (ScrollNotification scrollInfo) {
                    if (scrollInfo.metrics.pixels ==
                      ...
                      if (!myCarState.isFetchingMoreMyMarket! &&
                          myCarState.hasMoreDataMyMarket! &&
                          !myCarState.isLoadingMyMarket!) {
                        BlocProvider.of<ViewCarBloc>(context)
                            .add(FetchMyMarketVehicle(fetchingMore: true));
                        BlocProvider.of<ViewCarBloc>(context).add(
                            GetMyMarketVehicle(
                                page: myCarState.currentPageMyMarket!
                                    .toString()));
                      }
                    }
                    return false;
...
List<CarsForSell> cars = [
  CarsForSell(
      ...
      "18 Km/L",
      "201 HP",
      Assets.userThomas.name,
      "Thomas",
      true),
  CarsForSell(
      "2",
      Assets.carRenault.name,
      "Renault KWID",
      "2 Jan, 2022",
      "2021",
      r"$ 1,25,000",
