...
CardListModel cardListFromJson(String str) => CardListModel.fromJson(json.decode(str));

String cardListToJson(CardListModel data) => json.encode(data.toJson());
...
class CardListModel {
  ...
  factory CardListModel.fromJson(Map<String, dynamic> json) => CardListModel(
    ...
    data: List<CardList>.from(json["data"].map((x) => CardList.fromJson(x))),
  );
